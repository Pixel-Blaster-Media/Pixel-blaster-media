...
export default function SiteHeaderMobileMenu({
  ...
  return (
    <details ref={detailsRef} className="site-mobile-menu relative z-[160] md:hidden">
      <summary
      ...
      <nav className="absolute right-0 top-11 z-[170] w-56 rounded-2xl border border-realtor-primary/15 bg-white/95 p-2 text-sm shadow-xl shadow-realtor-text/15 backdrop-blur">
        {items.map((item) =>
          item.external ? (
            <a
              key={item.href}
