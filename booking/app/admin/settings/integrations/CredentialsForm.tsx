          ...
          <div key={f.name}>
            <label className="block">
              ...
              <input
                ...
                autoComplete="off"
                spellCheck={false}
                className="mt-1 w-full rounded-md border border-white/10 bg-ink-soft px-3 py-2 font-mono text-xs text-white placeholder-ink-muted focus:outline-none focus:ring-2 focus:ring-brand-light/60"
              />
              {f.helper ? (
