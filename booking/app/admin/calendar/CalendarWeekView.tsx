    ...
    <div className="max-w-full space-y-2 px-0.5">
      ...
      <div className="relative max-w-full space-y-2 pb-28 md:hidden">
        ...
        <button
          ...
          className="fixed bottom-[calc(5.75rem+env(safe-area-inset-bottom))] right-5 z-40 flex h-16 w-16 items-center justify-center rounded-full bg-realtor-primary text-4xl font-light leading-none text-white shadow-2xl shadow-realtor-text/30 transition hover:bg-realtor-primary-light"
        >
          +
        </button>
        ...
        <nav className="fixed inset-x-4 bottom-[max(0.75rem,env(safe-area-inset-bottom))] z-30 rounded-[28px] border border-[#d8cab9]/70 bg-white/95 px-2 py-2 shadow-2xl shadow-black/15 backdrop-blur">
          <div className="grid grid-cols-5 gap-1 text-[11px] font-semibold text-[#6f7a70]">
            <MobileNavTab href="/admin/calendar" label="Calendar" active>
              <rect x="3" y="4" width="18" height="17" rx="3" />
              <line x1="3" y1="9" x2="21" y2="9" />
              <line x1="8" y1="2" x2="8" y2="6" />
              <line x1="16" y1="2" x2="16" y2="6" />
            </MobileNavTab>
            <MobileNavTab href="/admin/bookings" label="Bookings">
              <path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z" />
              <circle cx="12" cy="13" r="4" />
            </MobileNavTab>
            <MobileNavTab href="/admin/settings/availability" label="Hours">
              <circle cx="12" cy="12" r="10" />
              <polyline points="12 6 12 12 16 14" />
            </MobileNavTab>
            <MobileNavTab href="/admin/realtors" label="Realtors">
              <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
              <circle cx="12" cy="7" r="4" />
            </MobileNavTab>
            <MobileNavTab href="/admin/settings" label="Settings">
