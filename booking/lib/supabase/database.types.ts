...
type AutoHDRSourceWorkerSettlementRow = {
  ingest_job_id: string; lifecycle_state: AutoHDRSourceLifecycleState;
...
type AutoHDRQuarantineCleanupClaimRow = {
  ...
  cleanup_lease_expires_at: string; lifecycle_state: AutoHDRSourceLifecycleState;
};
  ...
  public: {
    ...
    Functions: {
      ...
      reserve_or_reuse_autohdr_source_master: {
        Args: {
          p_organization_id: string; p_ingest_job_id: string; p_lease_token: string;
      ...
      complete_autohdr_source_file: {
        Args: {
          p_organization_id: string; p_ingest_job_id: string; p_lease_token: string;
          p_quarantine_etag: string; p_outcome: string; p_master_version_id: string;
          p_master_asset_id: string; p_master_batch_id: string; p_master_bucket_name: string;
          p_master_object_key: string; p_verified_width_px: number; p_verified_height_px: number;
        };
        Returns: AutoHDRSourceWorkerSettlementRow[];
      };
      settle_autohdr_source_file: {
        Args: {
          p_organization_id: string; p_ingest_job_id: string; p_lease_token: string;
          p_quarantine_etag: string; p_outcome: string; p_error_code: string;
        };
        Returns: AutoHDRSourceWorkerSettlementRow[];
      };
